...
class User private constructor(
    ...
    private fun generateAccessCode(): String {
        val possible = "ABCDEFGHIJKLMNNOPQRSTUVWXYZacbdefghijklmnopqrstuvwxyz0123456789"
    ...
    private fun String.md5(): String {
        ...
        val digets = md.digest(toByteArray()) // 16 byte
        val hexString = BigInteger(1, digets).toString(16)
                    ...
                    .run {
                        when (size) {
                            ...
                            2 -> first() to last()
                                    ...
                                    "Firstname must contain only first name " +
